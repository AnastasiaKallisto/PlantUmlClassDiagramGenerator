...
public partial class ClassDiagramGenerator(
    ...
    bool hideExternalAssociations = false,
    bool showMethodsAssociations = false) : CSharpSyntaxWalker
{
    ...
    private readonly bool showMethodsAssociations = showMethodsAssociations;
